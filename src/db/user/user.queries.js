export const SQL_QUERIES = {
  ...
  UPDATE_CHARACTER_STATUS:
    'UPDATE Characters SET character_level = ?, experience = ?, cur_hp = ?, max_hp = ?, cur_mp = ?, max_mp = ?, attack = ?, defense = ?, magic = ?, speed = ?, critical = ?, critical_attack = ?, avoid_ability = ?, updated_at = CURRENT_TIMESTAMP WHERE character_name = ? AND job_id = ?',
  UPDATE_CHARACTER_CUR_STATUS:
    'UPDATE Characters SET experience = ?, cur_hp = ?, cur_mp = ? WHERE character_name = ? AND job_id = ?',
};
